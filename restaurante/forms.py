...
class RestauranteForm(forms.ModelForm):
    class Meta:
        model = Restaurante
        fields = [
            'tipo_pessoa', 'cnpj', 'nome_restaurante', 'inscricao_estadual', 'inscricao_municipal',
            'cpf', 'rg', 'email', 'telefone', 'cep', 'endereco', 'numero', 'complemento',
            'bairro', 'cidade', 'estado', 'fator_correcao_financeiro'
        ]
        widgets = {
