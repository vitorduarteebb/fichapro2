    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ajuste_tipo', models.CharField(blank=True, help_text="Informe 'fator' para FATOR DE CORREÇÃO IC ou 'ipc' para IPC", max_length=10, null=True, verbose_name='TIPO DE AJUSTE')),
